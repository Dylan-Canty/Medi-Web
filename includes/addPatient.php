<div class="modal" id="add-patient">
        <div class=''>
            <button class="btn-small right-align modal-close float-right green"><i class="material-icons">close</i></button>
        </div>
        <form action="php/handler.php" method="POST" onsubmit="return addPatient(this)" class='container row'>
            <h4 class="center-align col s12">Add New Patient</h4>
            ...
            <div class="input-field center-align col s12">
                <button type="submit" name='addPatient' class='btn-small light-green darken-2 white-text'>SUBMIT</button>
            </div>
